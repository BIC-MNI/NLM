/* Vendored fallback copy of libminc/ezminc/minc_io_simple_volume.h, used only when
   NLM is built standalone with no sibling libminc checkout (see NLM/CMakeLists.txt).
   Keep in sync manually if the libminc original changes. */
/* ----------------------------- MNI Header -----------------------------------
@NAME       :
